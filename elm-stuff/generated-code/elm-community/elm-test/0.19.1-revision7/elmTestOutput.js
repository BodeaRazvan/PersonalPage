...
var $author$project$Model$Util$chainCompare = F2(
	function (ord2, ord1) {
		if (ord1.$ === 'EQ') {
			return ord2;
		} else {
...
var $author$project$Model$Date$compareMonth = F2(
	function (m1, m2) {
		return A2(
...
var $author$project$Model$Date$compare = F2(
	function (_v0, _v1) {
		var d1 = _v0.a;
		var d2 = _v1.a;
		var _v2 = _Utils_Tuple2(d1.month, d2.month);
		if (_v2.a.$ === 'Just') {
			if (_v2.b.$ === 'Just') {
				var m1 = _v2.a.a;
				var m2 = _v2.b.a;
				return A2(
					$author$project$Model$Util$chainCompare,
					A2($author$project$Model$Date$compareMonth, m1, m2),
...
var $author$project$Model$Date$calculateAbsolute = F2(
	function (x, y) {
...
var $author$project$Model$Date$monthsBetween = F2(
	function (dA, dB) {
		...
		var _v1 = dA;
		var date1 = _v1.a;
		var _v2 = _Utils_Tuple2(date1.month, date2.month);
		_v2$2:
		while (true) {
			if (_v2.a.$ === 'Just') {
				if (_v2.b.$ === 'Just') {
					...
					return $elm$core$Maybe$Just(
						$elm$core$Basics$abs(
							(12 * (date1.year - date2.year)) + ($author$project$Model$Date$monthToInt(m1) - $author$project$Model$Date$monthToInt(m2))));
				} else {
					break _v2$2;
				}
			} else {
				if (_v2.b.$ === 'Nothing') {
					...
					var _v4 = _v2.b;
					return $elm$core$Maybe$Just(
						12 * A2($author$project$Model$Date$calculateAbsolute, date1.year, date2.year));
				} else {
					break _v2$2;
				}
			}
...
var $author$project$VerifyExamples$Model$Date$ModuleDoc0$spec0 = A2(
	$elm_explorations$test$Test$test,
...
var $author$project$Model$Date$monthsBetweenMonths = F2(
	function (m1, m2) {
		var month2 = $author$project$Model$Date$monthToInt(m2);
		var month1 = $author$project$Model$Date$monthToInt(m1);
		return (_Utils_cmp(month1, month2) > -1) ? (month1 - month2) : (month2 - month1);
	});
...
var $author$project$Model$Event$Category$SelectedEventCategories = function (a) {
	return {$: 'SelectedEventCategories', a: a};
};
var $author$project$Model$Event$Category$allSelected = $author$project$Model$Event$Category$SelectedEventCategories(
	{academic: true, award: true, project: true, work: true});
...
var $author$project$Model$Event$Category$set = F3(
	function (category, value, current) {
		...
		switch (category.$) {
			case 'Academic':
				return $author$project$Model$Event$Category$SelectedEventCategories(
					_Utils_update(
						selEv,
						{academic: value}));
			case 'Work':
	...
	function (_v0, _v1) {
		...
		if (_v2.a.$ === 'Just') {
			if (_v2.b.$ === 'Just') {
				...
				return A2(
					$author$project$Model$Util$chainCompare,
					A2($author$project$Model$Date$compare, end1, end2),
					A2($author$project$Model$Date$compare, intA.start, intB.start));
			} else {
				var end1 = _v2.a.a;
				var _v5 = _v2.b;
				return A2(
...
var $author$project$VerifyExamples$Model$Interval$ModuleDoc0$spec0 = A2(
	$elm_explorations$test$Test$test,
...
var $author$project$VerifyExamples$Model$Date$ModuleDoc1$spec1 = A2(
	$elm_explorations$test$Test$test,
...
var $author$project$VerifyExamples$Model$Interval$ModuleDoc1$spec1 = A2(
	$elm_explorations$test$Test$test,
...
var $author$project$VerifyExamples$Model$Date$ModuleDoc2$spec2 = A2(
	$elm_explorations$test$Test$test,
...
var $author$project$VerifyExamples$Model$Interval$ModuleDoc2$spec2 = A2(
	$elm_explorations$test$Test$test,
...
var $author$project$VerifyExamples$Model$Date$ModuleDoc3$spec3 = A2(
	$elm_explorations$test$Test$test,
...
var $author$project$VerifyExamples$Model$Interval$ModuleDoc3$spec3 = A2(
	$elm_explorations$test$Test$test,
...
var $author$project$VerifyExamples$Model$Date$ModuleDoc4$spec4 = A2(
	$elm_explorations$test$Test$test,
...
var $author$project$VerifyExamples$Model$Interval$ModuleDoc4$spec4 = A2(
	$elm_explorations$test$Test$test,
...
var $author$project$VerifyExamples$Model$Date$ModuleDoc5$spec5 = A2(
	$elm_explorations$test$Test$test,
...
var $author$project$VerifyExamples$Model$Date$ModuleDoc6$spec6 = A2(
	$elm_explorations$test$Test$test,
...
var $author$project$VerifyExamples$Model$Date$ModuleDoc7$spec7 = A2(
	$elm_explorations$test$Test$test,
...
var $author$project$VerifyExamples$Model$Date$ModuleDoc8$spec8 = A2(
	$elm_explorations$test$Test$test,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromInt(d.year) + (' ' + function () {
							var _v1 = d.month;
							if (_v1.$ === 'Just') {
								var m = _v1.a;
								return $author$project$Model$Date$monthToString(m);
							} else {
								return '';
							}
						}()))
...
var $author$project$Model$Event$Category$view = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A3($author$project$Model$Event$Category$checkbox, 'Academic', selEv.academic, $author$project$Model$Event$Category$Academic),
				A3($author$project$Model$Event$Category$checkbox, 'Work', selEv.work, $author$project$Model$Event$Category$Work),
				A3($author$project$Model$Event$Category$checkbox, 'Project', selEv.project, $author$project$Model$Event$Category$Project),
				A3($author$project$Model$Event$Category$checkbox, 'Award', selEv.award, $author$project$Model$Event$Category$Award)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				event.important ? $elm$html$Html$Attributes$class('event-important') : $elm$html$Html$Attributes$class('')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('event-description')
					]),
				_List_fromArray(
					[event.description])),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($elm$core$Maybe$withDefault, '', event.url))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
...
var $author$project$Model$Interval$length = function (_v0) {
	var interval = _v0.a;
	return A2(
		$elm$core$Maybe$map,
		function (totalMonths) {
			return _Utils_Tuple2(
				(totalMonths / 12) | 0,
				A2($elm$core$Basics$modBy, 12, totalMonths));
		},
		A2(
			$elm$core$Maybe$andThen,
			$author$project$Model$Date$monthsBetween(interval.start),
			interval.end));
};
var $author$project$Model$Interval$view = function (interval) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('interval')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('interval-start')
					]),
				_List_fromArray(
					[
						$author$project$Model$Date$view(startDate)
					])),
				A2(
				$elm$html$Html$p,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('interval-end')
					]),
				function () {
					if (endDate.$ === 'Nothing') {
						return _List_fromArray(
						...
						return _List_fromArray(
							[
								$author$project$Model$Date$view(x)
							]);
					}
				}()),
				function () {
				var _v1 = $author$project$Model$Interval$length(interval);
				if (_v1.$ === 'Nothing') {
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('interval-length')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								'Years: ' + ($elm$core$String$fromInt(x) + (' Months:' + $elm$core$String$fromInt(y))))
							]));
				}
			}()
			]));
...
var $author$project$Model$personalDetails = {
	contacts: _List_fromArray(
		[
			A2($author$project$Model$PersonalDetails$DetailWithName, 'email', 'razvan.bodea2700@gmail.com'),
			A2($author$project$Model$PersonalDetails$DetailWithName, 'phone', '0768290209')
		]),
	intro: 'I like computers',
	name: 'Bodea Razvan-Marius',
	socials: _List_fromArray(
		[
			A2($author$project$Model$PersonalDetails$DetailWithName, 'github', 'https://github.com/BodeaRazvan'),
			A2($author$project$Model$PersonalDetails$DetailWithName, 'youtube channel', 'https://www.youtube.com/channel/UC0qvGCTHDGPmwNUFakGjpbQ')
		])
};
...
var $author$project$Model$PersonalDetails$detailsToString = function (contacts) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Name: ' + details.name)
					])),
				A2(
				$elm$html$Html$em,
				_List_fromArray(
				...
				A2(
					...
					A2($elm$core$List$map, $author$project$Model$PersonalDetails$detailsToString, details.contacts))),
				A2(
				$elm$html$Html$ul,
				_List_Nil,
				A2(
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href(s.detail),
...
var $author$project$RepoTests$suite = A2(
	$elm_explorations$test$Test$describe,
	'Model.Repo module',
	_List_fromArray(
		[
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/razvan/FP/Project1/tests/DateTests.elm', '/home/razvan/FP/Project1/tests/EventCategoryTests.elm', '/home/razvan/FP/Project1/tests/EventTests.elm', '/home/razvan/FP/Project1/tests/IntervalTests.elm', '/home/razvan/FP/Project1/tests/PersonalDetailsTests.elm', '/home/razvan/FP/Project1/tests/RepoTests.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/Compare0.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/Compare1.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/Compare2.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/Compare3.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/Compare4.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/Compare5.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/ModuleDoc0.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/ModuleDoc1.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/ModuleDoc2.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/ModuleDoc3.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/ModuleDoc4.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/ModuleDoc5.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/ModuleDoc6.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/ModuleDoc7.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/ModuleDoc8.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/MonthsBetweenMonths0.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/MonthsBetweenMonths1.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Date/MonthsBetweenMonths2.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Event/Category/AllSelected0.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Event/Category/IsEventCategorySelected0.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Event/Category/Set0.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Event/Category/Set1.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Interval/ModuleDoc0.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Interval/ModuleDoc1.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Interval/ModuleDoc2.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Interval/ModuleDoc3.elm', '/home/razvan/FP/Project1/tests/VerifyExamples/Model/Interval/ModuleDoc4.elm']),
		processes: 8,
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Model$Date$ModuleDoc0$spec0)
				])),
			_Utils_Tuple2(
			'VerifyExamples.Model.Date.ModuleDoc1',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Model$Date$ModuleDoc1$spec1)
				])),
			_Utils_Tuple2(
			'VerifyExamples.Model.Date.ModuleDoc2',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Model$Date$ModuleDoc2$spec2)
				])),
			_Utils_Tuple2(
			'VerifyExamples.Model.Date.ModuleDoc3',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Model$Date$ModuleDoc3$spec3)
				])),
			_Utils_Tuple2(
			'VerifyExamples.Model.Date.ModuleDoc4',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Model$Date$ModuleDoc4$spec4)
				])),
			_Utils_Tuple2(
			'VerifyExamples.Model.Date.ModuleDoc5',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Model$Date$ModuleDoc5$spec5)
				])),
			_Utils_Tuple2(
			'VerifyExamples.Model.Date.ModuleDoc6',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Model$Date$ModuleDoc6$spec6)
				])),
			_Utils_Tuple2(
			'VerifyExamples.Model.Date.ModuleDoc7',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Model$Date$ModuleDoc7$spec7)
				])),
			_Utils_Tuple2(
			'VerifyExamples.Model.Date.ModuleDoc8',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Model$Date$ModuleDoc8$spec8)
				])),
			_Utils_Tuple2(
			...
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Model$Interval$ModuleDoc0$spec0)
				])),
			_Utils_Tuple2(
			'VerifyExamples.Model.Interval.ModuleDoc1',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Model$Interval$ModuleDoc1$spec1)
				])),
			_Utils_Tuple2(
			'VerifyExamples.Model.Interval.ModuleDoc2',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Model$Interval$ModuleDoc2$spec2)
				])),
			_Utils_Tuple2(
			'VerifyExamples.Model.Interval.ModuleDoc3',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Model$Interval$ModuleDoc3$spec3)
				])),
			_Utils_Tuple2(
			'VerifyExamples.Model.Interval.ModuleDoc4',
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$VerifyExamples$Model$Interval$ModuleDoc4$spec4)
				]))
		]));
_Platform_export({'Test':{'Generated':{'Main':{'init':$author$project$Test$Generated$Main$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-16135.sock";
var net = require('net'),
